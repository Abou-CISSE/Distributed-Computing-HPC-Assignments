...
long solve_1d_burger_pyccel(int n0_u, double *u, int n0_un, double *un, long nt, long nx, double dt, double dx, double nu);
...
PyObject *solve_1d_burger_pyccel_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Out_0001 = solve_1d_burger_pyccel(PyArray_DIM(u, 0), PyArray_DATA(u), PyArray_DIM(un, 0), PyArray_DATA(un), nt, nx, dt, dx, nu);
    result = Py_BuildValue("l", Out_0001);
    return result;
}
/*........................................*/

static PyMethodDef mod_hkknft51_methods[] = {
    {
...
static struct PyModuleDef mod_hkknft51_module = {
    ...
    -1,
    mod_hkknft51_methods
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hkknft51(void)
{
    PyObject *m;

    import_array();

    m = PyModule_Create(&mod_hkknft51_module);
