...
static PyMethodDef mod_tnebzcbn_methods[] = {
    {
...
static struct PyModuleDef mod_tnebzcbn_module = {
    ...
    -1,
    mod_tnebzcbn_methods
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tnebzcbn(void)
{
    PyObject *m;

    import_array();

    m = PyModule_Create(&mod_tnebzcbn_module);
