...
function solve_1d_burger_pyccel(u, un, nt, nx, dt, dx, nu) result( &
  ...
  do it = 0_C_LONG_LONG, nt-1_C_LONG_LONG, 1_C_LONG_LONG
    ...
    u(0_C_LONG_LONG) = un(0_C_LONG_LONG) - p * un(0_C_LONG_LONG) * (un( &
      0_C_LONG_LONG) - un(nx - 2_C_LONG_LONG)) + k * (un(1_C_LONG_LONG &
      ) - 2_C_LONG_LONG * un(0_C_LONG_LONG) + un(nx - 2_C_LONG_LONG))
    u(nx - 1_C_LONG_LONG) = u(0_C_LONG_LONG)
  end do
