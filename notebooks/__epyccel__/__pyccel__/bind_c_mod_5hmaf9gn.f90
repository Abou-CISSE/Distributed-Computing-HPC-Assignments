!........................................
function solve_1d_burger_pyccel(n0_u, u, n0_un, un, nt, nx, dt, dx, nu) &
      bind(c) result(Out_0001)

  use mod_5hmaf9gn, only: mod_solve_1d_burger_pyccel => &
  ...
  Out_0001 = mod_solve_1d_burger_pyccel(u, un, nt, nx, dt, dx, nu)
